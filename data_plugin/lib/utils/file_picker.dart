...
class FilePicker {
  ...
  static Future<Map<String, String>?> getMultiFilePath(
      ...
      await (_getPath(_handleType(type, fileExtension), true) as FutureOr<Map<String, String>?>);
  ...
  static Future<String?> getFilePath(
          {FileType type = FileType.ANY, String? fileExtension}) async =>
      await (_getPath(_handleType(type, fileExtension), false) as FutureOr<String?>);
